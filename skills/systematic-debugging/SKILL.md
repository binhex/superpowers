...
Call these gates AFTER the bug is fixed and verified, and BEFORE committing. Do NOT call them during the investigation or hypothesis phases. These gates are absolute and not subject to skill priority ordering.
...
| "I already debugged this systematically" | Debugging ≠ adversarial review. Both required. |
